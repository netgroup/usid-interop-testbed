...
simple_switch --device-id 2 --thrift-port $THRIFT_PORT -i 0@$NODE_NAME-vpp_1 -i 1@$NODE_NAME-vpp_2 -i 2@$NODE_NAME-p4_1 -i 3@$NODE_NAME-vpp_3 $PWD/$BASE_DIR/$NODE_NAME/bmv2.json &
